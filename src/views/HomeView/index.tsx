    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-800 text-white">
      <div className="max-w-xl rounded-lg bg-gray-700  p-10 text-center shadow-lg backdrop-blur-md">
        ...
        <p className="mb-8 text-lg">
          ...
          創造的なアルゴリズムと最適化技術を駆使して、コードの長さを最小限にしましょう。
        </p>
        <Link href="/questions">
          <p className="inline-block rounded-lg bg-blue-600 px-8 py-4 font-semibold text-white shadow-md transition duration-300 hover:scale-105 hover:bg-blue-700">
            コードゴルフ一覧に行く
          </p>
        </Link>
      </div>
