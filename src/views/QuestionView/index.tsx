...
export const QuestionView = React.memo<Props>(function QuestionView({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-800 px-10 text-white">
          ...
          <SectionFrame title="回答" className="mt-2">
            ...
            <div className="mt-3 flex items-center">
              ...
              <input
                ...
                className="rounded-md border-2 border-gray-500 bg-gray-600 px-4 py-2 text-white placeholder:text-gray-400 focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300"
              />
            </div>
            <div className="mt-3">
              <SmallButton
